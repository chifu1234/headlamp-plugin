...
export function TenantLinksBar() {
	...
	const currentTenantData = selectedTenantData.find(
		(t) => t.name === currentTenantName,
	);
						...
						<>
							...
							>
								{currentTenantData.icon && (
									<Avatar
										src={safeUrl(currentTenantData.icon)}
